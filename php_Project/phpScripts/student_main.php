<?php
    ...
    $select_query = "SELECT * FROM users WHERE id = '$student_id' AND role = 'student'";
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
      ...
      if ($category == 'all'){
        $select = "Select mi.name as name, mi.category_id as category_id, mi.id as id, mi.price as price, mi.description as description, mi.image_path as image_path, c.name as categoryName from menu_items mi join categories c on c.id = mi.category_id";
...
<head>
  ...
  <title>Student Dashboard - Sunway Canteen</title>
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item"><a class="nav-link active" href="<?= $isLoggedIn ? 'admin_main.php' : 'login.php' ?>">Menu</a></li>
          <li class="nav-item"><a class="nav-link" href="<?= $isLoggedIn ? 'allOrders.php' : 'login.php' ?>">Orders</a></li>
        </ul>
      </div>
    </div>
  </nav>
  <div class="text-center py-4" style="background: linear-gradient(to right, #4B1D1D, #1a1a1a); color: #ffcc99;">
        ...
        <p class="text-light">Student Menu Dashboard</p>
   </div>
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center my-4">
            <div class="nav-links">
                <a href="myOrders.php?student_id=<?php echo $student_id; ?>" class="btn btn-outline-primary me-2">My Orders</a>
                <a href="orderHistory.php?student_id=<?php echo $student_id; ?>" class="btn btn-outline-primary me-2">History</a>
                
            </div>
            <a href="feedback.php" class="btn btn-outline-secondary">Feedbacks</a>
        </div>
            ...
            ?>
                ...
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="mt-auto d-flex justify-content-between">
                        <a href="addToCart.php?menu_id=<?= $rowData['id'] ?>&user_id=<?= $student_id ?>" class="btn btn-sm btn-primary">ADD</a>
                    </div>
                    </div>
                </div>
                </div>
